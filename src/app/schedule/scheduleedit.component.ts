...
export class ScheduleEditComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.scheduleService.getScheduleById(this.id)
      .pipe(first())
      .subscribe(x => {
        this.formInput.schedule_name = x.scheduleType_id;
        this.formInput.shift_name = x.shift_id;
        this.formInput.partset_code = x.partSet_Code;
        this.formInput.partset_name = x.partSet_Id;
        var dtStartPlanned = x.schedule_StartDate.split('-');
        ...
        var dtEndPlanned = x.schedule_EndDate.split('-');
        ...
        this.formInput.quantity = x.required_Quantity;
        this.formInput.station_name = x.workstation_id;
      });
  ...
  saveStep1(form: any) {
    ...
    localSchedule.required_Quantity = this.formInput.quantity;
    ...
    localSchedule.id = parseInt(this.id, 10);
    this.scheduleService.updateSchedule(localSchedule)
      .pipe(first())
      .subscribe(returnObj => {
