...
@Component({
  selector: 'app-workorderfile',
  templateUrl: './workorderfile.component.html',
  styleUrls: ['./workorder.component.css']
})
export class WorkOrderFileComponent implements OnInit {
  dataSourceUpload = new MatTableDataSource();
  displayedPartColumns: string[] = ['id', 'file_name', 'file_type', 'actions'];
  ...
  upload(): void {
    ...
    this.uploadService.upload(this.currentFile, this.woId, this.fileType).subscribe(
      event => {
